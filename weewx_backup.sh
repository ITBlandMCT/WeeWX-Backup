...
echo
echo "Backing up $backup_files1 to /home/pi/$archive_file"
echo "Backing up $backup_files2 to /home/pi/$archive_file"
echo "Backing up $backup_files3 to /home/pi/$archive_file"
echo "Backing up $backup_files4 to /home/pi/$archive_file"
echo
...
tar -czf /home/pi/$archive_file $backup_files1 $backup_files2 $backup_files3 $backup_files4
echo
echo "Backup of created in /home/pi"
